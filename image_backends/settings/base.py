"""
Django settings for image_backends project.
...
ROOT_URLCONF = "image_backends.urls"
...
WSGI_APPLICATION = "image_backends.wsgi.application"
...
WAGTAIL_SITE_NAME = "image_backends"
...
PROXY_URL_FOR_IMGIX = os.getenv("PROXY_URL")
